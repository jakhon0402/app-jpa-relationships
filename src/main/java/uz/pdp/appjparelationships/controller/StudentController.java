...
public class StudentController {
    ...
    public String addStudent(@RequestBody StudentDto studentDto){
        ...
        if(optionalGroup.isPresent()){
            ...
            for (Integer subjectsId : studentDto.getSubjectsIds()) {
                subjectList.add(subjectRepository.findById(subjectsId).get());
            }
        ...
        else return "Bunday idlik group mavjud emas !";
    }
    ...
    public String deleteStudent(@PathVariable Integer id){
        ...
        else return "Bunday idlik student mavjud emas !";
    }
